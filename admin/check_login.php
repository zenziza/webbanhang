...
if(isset($_POST['login']))
{
    $username = $_POST['user'];
    $password = $_POST['pass'];
    $sql_check = mysqli_query("select * from users where username = '$username'");
    ...
    {
        $sql_check2 = mysqli_query("select * from users where username = '$username' and password = '$password'");
